...
public class TransferUI extends JFrame {
    ...
    public TransferUI(String username) {
        setTitle("Group E Bank - Transfer");
        setSize(420, 380);
        ...
        senderField = createStyledField("Your account number");
        gbc.gridy++;
        panel.add(senderField, gbc);

        receiverField = createStyledField("Recipient's account number");
        gbc.gridy++;
        ...
        transferButton = createRoundedButton("Send Money");
        gbc.gridy++;
        panel.add(transferButton, gbc);

        add(panel);
        new TransferController(this, username);
    }
    ...
    private JButton createRoundedButton(String text) {
        ...
        button.setBorder(BorderFactory.createLineBorder(new Color(0, 150, 136), 1));
    ...
    public JTextField getSenderField() { return senderField; }
    public JTextField getReceiverField() { return receiverField; }
